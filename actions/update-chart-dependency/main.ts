...
export async function run(): Promise<void> {
  ...
  try {
    ...
    const chartDirs = chartDirents
      .filter((dirent) => dirent.isDirectory())
      .map((dirent) => {
        /**
         * @description Ensure dirent.name is always string
         */
        return typeof dirent.name === 'string' ? dirent.name : (dirent.name as Buffer).toString();
      })
      .filter((dir) => {
...
export { getFileSha, updateChartYamlDependency, updateHelmfileReleaseVersion };
